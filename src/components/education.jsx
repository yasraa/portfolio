...
function Education({ scrollContainer }) {
  ...
  useGSAP(() => {
    console.log("Scroll container ref:", scrollContainer?.current);

    ScrollTrigger.defaults({ markers: false }); // you can enable markers if debugging

    const scrollerEl = scrollContainer?.current || window;
  ...
  return (
    <div className="education" id="section2" ref={typeRef}>
                  ...
                  <div className="kkj">
                    ...
                    <div className="bar">
                      <div className="prog-bar">
                        <div className="main-progbar" style={{ width: image.style.width }}></div>
                      </div>
                      <div className="percentage">{image.per}</div>
                    </div>
                  </div>
                </div>
              ))}
